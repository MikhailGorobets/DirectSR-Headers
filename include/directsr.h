...
// CLSID_D3D12DSRDeviceFactory is declared in d3d12.h but not defined in any import library.
// Provide an inline definition so consumers don't need to link dxguid.lib or use initguid.h.
// clang-format off
